...
% ----------------------- ALGORITHMS ----------------------------
\begin{textblock}{190}(0,27)
    \input{sections/algorithms.tex}
\end{textblock}

\begin{textblock}{60}(0,72)
    \input{sections/radixsort.tex}
\end{textblock}

\begin{textblock}{60}(65,72)
    \input{sections/quicksort.tex}
\end{textblock}

\begin{textblock}{60}(130,72)
    \input{sections/burstsort.tex}
\end{textblock}


% ----------------------- TEST DATA -----------------------------
\begin{textblock}{180}(0,180)
